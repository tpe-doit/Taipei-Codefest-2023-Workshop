# -*- coding: utf-8 -*-
"""
Created on Mon Aug  1 16:58:50 2022
...
''' 方便其他script引用
import sys
sys.path.append(r'D:\iima\gitlab\tuic-pipeline-airflow\new_flow_test')
from etl_function import convert_geometry_to_wkbgeometry, convert_str_to_time_format, get_tpe_now_time_str
'''
...
class Preload:
    ...
    def to_time_contain_chinese_string(self, x):
        '''
    ...
    def _parse_from_format(self, from_format):
        '''
        解析from_format以做後續利用
    ...
    def _standardize_time_string(self, column, from_format):
        '''
        ...
        pattern, items = self._parse_from_format(from_format)
    ...
    def convert_str_to_time_format(self, column: pd.Series, from_format=None,
        ...
        '''
        if from_format:
            column = self._standardize_time_string(column, from_format)
    ...
    def get_datataipei_data_updatetime(self, url):
        '''
    ...
    def get_datataipei_data_file_last_modeified_time(self, url, rank=0):
        '''
    ...
    def linestring_to_multilinestring(self, geo):
        '''
    ...
    def taipei_opendata_offset_function(self, rid):
        '''
    ...
    def given_string_to_none(self, input_str, given_str, mode='start'):
        '''
    ...
    def get_tpe_now_time_timestamp(self, minutes_delta=None):
        '''
        Get now time with tz = 'Asia/Taipei'.
        '''
